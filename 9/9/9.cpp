...
int main()
{
    ...
    cin >> n;
    // добавил условие, чтобы счётчик не вылетал за 6
    if ((k % 7 + n) > 6)
        cout << "В этом году номер этого дня = " << k % 7 + n - 7 << endl;
    else
    ...
    cout << " таких квадра/тов и останется ещё " << a * b - c * c * ((int) a / c) * ((int) b / c);
